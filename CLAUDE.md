...
- **Imposto e rendimento usam datas diferentes, de propósito** — foi o que finalmente fez bater com o extrato:
  ...
  - **O rendimento é só dos dias úteis que o Bacen já publicou.** Chegamos a projetar a ponta que falta repetindo a última taxa, e o app ficou um dia *à frente* do banco — ele também espera a taxa sair. Os specs travam os dois erros, um de cada lado.
  - Conferido contra o extrato em 2026-08-09 (série até 06/08, liquidação em 10/08): 18 dias úteis de rendimento + IOF de 27 dias reproduzem os R$ 8.082,74 do banco a menos de R$ 0,40 — resíduo que é a diferença de principal (8.009,57 vs 8.009,93), não do cálculo.
