...
export class InvestmentsDashboardService {
  ...
  async summary(userId: string, forceRefresh = false) {
    ...
    // Principal, e não o aportado em regime de caixa: é a mesma base que o extrato do banco usa em
    // "Valor total investido", inclusive depois de um resgate parcial (conferido contra o banco em
    // 2026-08-09). Misturar as duas convenções entre tela e dashboard seria pior que qualquer uma.
